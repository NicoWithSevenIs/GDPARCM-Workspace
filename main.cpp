...
int main() {
    ...
    world.add(make_shared<sphere>(point3(0, -1000, 0), 1000, ground_material));
     ...
     for (int a = -11; a < 11; a++) {
        for (int b = -11; b < 11; b++) {
            ...
            point3 center(a * random_double() +  random_double(), 0.2, b * random_double() +  random_double());
            ...
            if ((center - point3(4, 0.2, 0)).length() > 0.9) {
                ...
                if (choose_mat < 0.8) {
                    // diffuse
                    sphere_material = make_shared<lambertian>(color::random(0.3, 1));
    ...
    auto material4 = make_shared<lambertian>(color(0.4, 0.2, 0.1));
    world.add(make_shared<sphere>(point3(-10, 1, 0), 1.5, material4));
